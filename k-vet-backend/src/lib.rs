...
#[openapi(
    ...
    paths(
        ...
        api::patient_treatments::detail,
        api::patient_treatments::patch_record,
        api::patient_treatments::list_files,
        ...
        api::text_blocks::list,
        api::text_blocks::create,
        api::text_blocks::detail,
        api::text_blocks::patch,
        api::text_blocks::archive,
        api::text_blocks::unarchive,
        api::picker::items,
    ...
    tags(
        ...
        (name = "textBlocks", description = "Reusable snippets for findings and reports"),
