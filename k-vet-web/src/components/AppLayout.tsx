...
export function AppLayout() {
  ...
  return (
    // A column so the banner spans the whole width above both layouts; the row that the
    // desktop rail and the content live in is the inner one.
      ...
      <div className="flex flex-1 flex-col sm:flex-row">
        ...
        <nav className="hidden w-56 shrink-0 flex-col border-r border-line bg-cream px-3 py-4 sm:flex">
          <Link to="/" className="px-2">
            ...
            <span className="block text-2xl font-bold uppercase tracking-tight text-rust">
              k-vet
            </span>
          </Link>
